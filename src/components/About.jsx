  ...
  return (
    <div className="">
          ...
          <div className="mx-auto max-w-7xl px-6 pb-32 pt-36 sm:pt-60 lg:px-8 lg:pt-32 ">
            <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center font-lilita-One ">
              <div className="w-full max-w-xl lg:shrink-0 xl:max-w-2xl  rounded-2xl  ">
                <h1 className="text-[2.0rem] sm:text-[3.5rem] md:text-[3.6rem] lg:text-[3.6rem] xl:text-[4.5rem]  text-slate-900    mt-6 font-normal ">
                  Acerca de la Empresa.
                </h1>
                <p className="relative mt-6 text-[1.2rem] leading-8 text-gray-600 sm:max-w-md lg:max-w-none mx-2 font-cabecera">
      ...
      <div className="mx-auto -mt-12 max-w-7xl px-6 sm:mt-0 lg:px-8 xl:-mt-8">
        <div className="w-full max-w-xl lg:shrink-0 xl:max-w-2xl  rounded-2xl   ">
          <h2 className="text-[2.0rem] sm:text-[3.5rem] md:text-[3.6rem] lg:text-[3.6rem] xl:text-[4.5rem]  text-slate-900    sm:text-6xl  mx-2 font-lilita-One">
            Nuestra Mision
          </h2>
