      ...
      },
      {
        ...
        details: [
          //color beige casaca con capucha
          {
            id: "1",
            op: "1",
            name: "Casaca Jeans clasica con Capucha (Celeste)",
            codigo: "Codigo",
            description: `Casaca`,
            formato1: "Tallas (2,4,6,8) Precio x Mayor S/.38",
            formato2: "Tallas (10,12) Precio x Mayor S/.40",
          ...
          },
          {
            id: "2",
            op: "1",
            name: "Casaca Jeans clasica con Capucha (Maiz)",
            codigo: "Codigo",
            description: `Casaca`,
            formato1: "Tallas (2,4,6,8) Precio x Mayor S/.38",
            formato2: "Tallas (10,12) Precio x Mayor S/.40",
          ...
          },
          {
            id: "3",
            op: "1",
            name: "Casaca Jeans clasica con Capucha (Negro)",
            codigo: "Codigo",
            description: `Casaca`,
            formato1: "Tallas (2,4,6,8) Precio x Mayor S/.38",
            formato2: "Tallas (10,12) Precio x Mayor S/.40",
          ...
          },
          {
            id: "4",
            op: "1",
            name: "Casaca Jeans clasica con Capucha (Cristal)",
            codigo: "Codigo",
            description: `Casaca`,
            formato1: "Tallas (2,4,6,8) Precio x Mayor S/.38",
            formato2: "Tallas (10,12) Precio x Mayor S/.40",
          ...
          },
          {
            id: "5",
            op: "1",
            name: "Casaca Jeans clasica con Capucha (Moteado)",
            codigo: "Codigo",
            description: `Casaca`,
            formato1: "Tallas (2,4,6,8) Precio x Mayor S/.38",
            formato2: "Tallas (10,12) Precio x Mayor S/.40",
                        ...
                        <div className="lg:grid lg:grid-cols-3 lg:items-start lg:gap-x-2  ">
                          ...
                          <div className="col-span-1 mt-10 px-4 sm:mt-16 sm:px-0 lg:mt-0 ">
                            ...
                            <div id="idcolores" className="">
                              ...
                              <div
                                className=" sm:flex sm:items-center sm:space-x-10 sm:space-y-0"
                                id="idcolores"
                              >
                                {params.sexo === "1"
                                  ? colores === 0
                            ...
                            <div id="idtotal">
                              <div className="flex items-start justify-start text-2xl font-mono text-base pt-6 ">
                                ...
                                <div className="grid grid-cols-3">
                                  <div
                                    className="col-span-1 border-2 border-slate-200 rounded"
                                    id="idmenos"
                                  >
                                    <Button
                            ...
                            <form className="mt-6">
                              ...
                              <div className="grid grid-cols-1  ">
                                ...
                                <div className="col-span-1 ">
                                  <h2
                                    className="font-cabecera text-2xl text-slate-900  text-left  "
                                    id="idMensajenulo"
                                  ></h2>
                                </div>
                              ...
                              <h2
                                id="idmensaje"
                                className=" text-1xl font-cabecera font bold pt-2 text-center text-slate-900"
                              >
                                {mensaje}
                              </h2>
                            </form>
