...
const Categoryproductsfc = [
  ...
  },
  {
    ...
    description: "",
    imageSrc:
      "https://i.postimg.cc/gj1ddLwm/Dise-o-sin-t-tulo-14-removebg-preview.png",
    imageAlt:
      "Person using a pen to cross a task off a productivity paper card.",
  },
];
            ...
            >
              ...
              <li className="flex">
                <div className="flex items-center">
                  ...
                  <a className="ml-4  text-[0.9rem] sm:text-[1.2rem] text-gray-500 hover:text-gray-700 font-Rum-Raisin ">
                    Catalogo x Mayor
                  </a>
                </div>
              </li>
