  ...
  const ProductDetailsfc = {
    categories: [
      //GRUPO(1) Casacas
      {
        ...
        datetime: "2021-07-12",
        status: "delivery",
        productName: "Conjunto Overol Lola Forro (Lila,Blanco,Rosado)",
        href: "#",
      ...
      },
      {
        ...
        status: "delivery",
        productName:
          "Conjunto Overol Lady Jeans Strech Forro (Lila,Blanco,Rosado)",
        href: "#",
        imageSrc:
      ...
      },
      {
        ...
        datetime: "2021-07-12",
        status: "delivery",
        productName: "Conjunto Pantalon con Forro (Lila,Blanco,Rosado)",
        href: "#",
        imageSrc:
            ...
            <div className="fixed inset-0 overflow-y-auto">
              <div className="flex min-h-full items-center justify-center p-4 text-center">
                      ...
                      <div className="mx-auto max-w-6xl   sm:px-6 sm:py-10 lg:max-w-7xl lg:px-8 border-2  rounded-3xl ">
                        <div className="lg:grid lg:grid-cols-3 lg:items-start lg:gap-x-2  ">
                          ...
                          <div className="col-span-1 mt-10 px-4 sm:mt-16 sm:px-0 lg:mt-0 ">
                            ...
                            />
                            <h2 className="font-bold pb-1  ">Colores</h2>
                ...
                focus:ring-2 dark:bg-gray-700 dark:border-gray-600 "
                            ...
                            <h3 className="pb-2 font-bold">Tallas</h3>
                            <div className="flex ">
                              <Container
                                active={activeIndex === 2}
                                onClick={() =>
                            ...
                            <h4 className="pb-2 font-bold">Precio</h4>
