      ...
      <Transition appear show={isOpen} as={Fragment} onClose={setOpen}>
        ...
        >
          ...
          <div className="fixed inset-0 ">
            <Dialog.Panel className=" w-full  font-title text-1xl max-w-7xl transform overflow-hiddenrounded-2xl bg-gradient-to-r from-sky-200 via-blue-200 to-cyan-100 p-6 text-left align-middle shadow-xl transition-all">
